...
| `pagination`                          | 分页组件[PlusPagination](/components/pagination.html) 的 props，不包含`total`，`modelValue`，`pageSizeList`。不需要分页可以给`false`(<el-tag>v0.1.0</el-tag> 新增)。                                                                       | `object` \| `false`( <el-tag>v0.1.0</el-tag> 新增)                                                                             |                                                 | 否       |
| `isCard`                              | 表格和搜索是否需要 el-card 包裹 默认 true                                                                                                                                                                                                  |
| `dividerProps`<el-tag>v0.1.0</el-tag> | 表格和搜索是否需要 el-divider 分割                                                                                                                                                                                                         | `object` \| `false`                                                                                                            | `false`                                         | 否       |
| `searchCardProps`                     | 搜索外层的 el-card 的 props ，当 isCard 为 true 时生效                                                                                                                                                                                     | `object`                                                                                                                       | `{}`                                            | 否       |
| `tableCardProps`                      | 表格外层的 el-card 的 props ，当 isCard 为 true 时生效                                                                                                                                                                                     | `object`                                                                                                                       | `{}`                                            | 否       |
